...
//    }
    ...
    public void testSetModifyGetUserFeatures() {
        ...
        //add user features
        HashMap<String, String> features = new HashMap<>();
        features.put("category.sport", "test");
        features.put("category.world", "test2");
        ...
        Integer page = null;
        HashMap<String, String> getExpResult = new HashMap<>();
        getExpResult.put("category.sport", "test");
        getExpResult.put("category.world", "test2");
        ...
        features.put("category.world", "25");
        ...
        getExpResult.put("category.world", "25");
        ...
        getExpResult.put("category.world", "30");
